    ...
    <div className="min-h-screen flex items-center justify-center px-6 relative">
      ...
      >
        ...
        <motion.div variants={formItem} initial="hidden" animate="show">
          ...
          <p className="text-sm text-white/30 mt-3">Start finding your perfect role</p>
        </motion.div>
        ...
        >
          <motion.div variants={formItem}>
            <label className="block text-[11px] text-white/25 mb-2 uppercase tracking-wider">Full Name</label>
          ...
          <motion.div variants={formItem}>
            ...
            <p className="text-[11px] text-white/20 text-center mt-3">
              You can fill in your profile details later
            </p>
          </motion.div>
        </motion.form>
        ...
        >
          <p className="text-[10px] text-white/20 mb-1.5 uppercase tracking-wider">What you get</p>
          <div className="space-y-1.5">
            {['AI-powered job matching', 'Application tracking', 'Career intelligence'].map((item) => (
